...
def create_link(hisse):
    return f"[{hisse}](https://www.tradingview.com/symbols/BIST:{hisse}/)"

async def main():
    # 600+ Hisse Listesi (Tam Liste)
